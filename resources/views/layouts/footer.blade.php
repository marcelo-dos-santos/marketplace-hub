    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center mb-4">
                    ...
                    <span class="ml-2 text-xl font-bold">Marketplace Hub</span>
                </div>
                <p class="text-gray-300 mb-4">
                    A plataforma mais completa para vendedores e compradores. 
                    Conectamos pessoas através do comércio digital.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white">Seja um Vendedor</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white">Status do Sistema</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center">
            <p class="text-gray-400">
                © {{ date('Y') }} Marketplace Hub. Todos os direitos reservados.
            </p>
        </div>
    </div>
</footer> 